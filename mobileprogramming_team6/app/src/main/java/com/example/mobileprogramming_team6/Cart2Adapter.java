    ...
    public void onBindViewHolder(@NonNull Cart2Adapter.Cart2ViewHolder holder, int position) {
            ...
            public void onClick(View view) {
                ...
                if (holder.btnNoti.isSelected()){
                    if (am_subs == null){
                        ...
                        Log.d("string?", holder.tvSubscriptDate.getText().toString());
        ...
        holder.btnDel.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                FirebaseDatabase.getInstance().getReference("Users/user1/subscriptDate").child(holder.tvName.getText().toString()).removeValue();
